...
dependencies {
    testImplementation(project(":apologist-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../apologist-java-core/src/main/resources/META-INF/proguard/apologist-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.apologist.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../apologist-java-core/src/main/resources/META-INF/proguard/apologist-java-core.pro",
