...
package com.apologist.api.proguard
...
internal class ProGuardCompatibilityTest {
    ...
    fun proguardRules() {
        val rulesFile =
            javaClass.classLoader.getResourceAsStream("META-INF/proguard/apologist-java-core.pro")
    ...
    @Test
    fun client() {
        val client = ApologistOkHttpClient.builder().apiKey("My API Key").build()
