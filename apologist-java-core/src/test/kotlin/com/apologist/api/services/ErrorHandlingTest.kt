...
import com.apologist.api.errors.ApologistException
import com.apologist.api.errors.BadRequestException
import com.apologist.api.errors.InternalServerException
import com.apologist.api.errors.NotFoundException
import com.apologist.api.errors.PermissionDeniedException
import com.apologist.api.errors.RateLimitException
import com.apologist.api.errors.UnauthorizedException
import com.apologist.api.errors.UnexpectedStatusCodeException
import com.apologist.api.errors.UnprocessableEntityException
...
internal class ErrorHandlingTest {
    ...
    fun petUpdateInvalidJsonBody() {
        ...
        val e =
            assertThrows<ApologistException> {
                petService.update(
                    Pet.builder()
                        .name("doggie")
                        .addPhotoUrl("string")
