...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.apologist.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.apologist.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.apologist.api.** {
    <init>(...);
