...
/**
 * A client for interacting with the Apologist REST API synchronously. You can also switch to
...
interface ApologistClient {
     ...
     * this client.
     */
    fun async(): ApologistClientAsync
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): ApologistClient
    ...
    /** A view of [ApologistClient] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): ApologistClient.WithRawResponse
