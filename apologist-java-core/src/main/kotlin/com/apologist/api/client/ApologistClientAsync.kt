...
/**
 * A client for interacting with the Apologist REST API asynchronously. You can also switch to
 ...
 * may call [close].
 */
interface ApologistClientAsync {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): ApologistClientAsync
    ...
    /**
     * A view of [ApologistClientAsync] that provides access to raw HTTP responses for each method.
     */
