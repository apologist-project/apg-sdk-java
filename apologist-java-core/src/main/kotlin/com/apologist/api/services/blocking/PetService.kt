...
import com.apologist.api.models.pet.PetCreateParams
import com.apologist.api.models.pet.PetDeleteParams
import com.apologist.api.models.pet.PetFindByStatusParams
import com.apologist.api.models.pet.PetFindByTagsParams
import com.apologist.api.models.pet.PetRetrieveParams
...
import com.apologist.api.models.pet.PetUploadImageResponse
...
interface PetService {
    ...
    fun updateWithForm(petId: Long) = updateWithForm(petId, PetUpdateWithFormParams.none())
    ...
    fun updateWithForm(
        petId: Long,
        params: PetUpdateWithFormParams = PetUpdateWithFormParams.none(),
    ) = updateWithForm(petId, params, RequestOptions.none())
    ...
    /** @see updateWithForm */
    fun updateWithForm(params: PetUpdateWithFormParams) =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun updateWithForm(petId: Long): HttpResponse =
        ...
        fun updateWithForm(
            petId: Long,
            params: PetUpdateWithFormParams = PetUpdateWithFormParams.none(),
        ): HttpResponse = updateWithForm(petId, params, RequestOptions.none())
        ...
        /** @see updateWithForm */
        @MustBeClosed
        fun updateWithForm(params: PetUpdateWithFormParams): HttpResponse =
            updateWithForm(params, RequestOptions.none())
