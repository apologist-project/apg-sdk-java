...
import com.apologist.api.core.Enum
import com.apologist.api.core.ExcludeMissing
import com.apologist.api.core.JsonField
import com.apologist.api.core.JsonMissing
import com.apologist.api.core.JsonValue
import com.apologist.api.core.checkKnown
import com.apologist.api.core.checkRequired
import com.apologist.api.core.toImmutable
import com.apologist.api.errors.ApologistInvalidDataException
...
private constructor(
    ...
    /**
     * @throws ApologistInvalidDataException if the JSON field has an unexpected type or is
    ...
    /**
     * @throws ApologistInvalidDataException if the JSON field has an unexpected type (e.g. if the
    ...
    fun isValid(): Boolean =
        try {
            validate()
            true
        } catch (e: ApologistInvalidDataException) {
            false
        }
    ...
    private constructor(
        ...
        /**
         * @throws ApologistInvalidDataException if the JSON field has an unexpected type (e.g. if
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
         ...
         *
         * @throws ApologistInvalidDataException if this class instance's value is a not a known
         *   member.
         */
        fun known(): Known =
            when (this) {
                ...
                SOLD -> Known.SOLD
                else -> throw ApologistInvalidDataException("Unknown Status: $value")
            }
         ...
         *
         * @throws ApologistInvalidDataException if this class instance's value does not have the
         *   expected primitive type.
         */
        fun asString(): String =
            _value().asString().orElseThrow {
                ApologistInvalidDataException("Value is not a String")
            }
