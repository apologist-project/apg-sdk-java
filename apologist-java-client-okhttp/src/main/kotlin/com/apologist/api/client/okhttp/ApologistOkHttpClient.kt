...
import com.apologist.api.client.ApologistClientImpl
...
/**
 * A class that allows building an instance of [ApologistClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class ApologistOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [ApologistClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): ApologistClient = builder().fromEnv().build()
    }

    /** A builder for [ApologistOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ApologistClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ApologistClient =
            ApologistClientImpl(
                clientOptions
                    .httpClient(
