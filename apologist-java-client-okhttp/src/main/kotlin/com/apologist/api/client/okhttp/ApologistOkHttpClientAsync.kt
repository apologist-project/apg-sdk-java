...
package com.apologist.api.client.okhttp

import com.apologist.api.client.ApologistClientAsync
import com.apologist.api.client.ApologistClientAsyncImpl
import com.apologist.api.core.ClientOptions
import com.apologist.api.core.Sleeper
import com.apologist.api.core.Timeout
import com.apologist.api.core.http.Headers
import com.apologist.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [ApologistClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class ApologistOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [ApologistClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): ApologistClientAsync = builder().fromEnv().build()
    }

    /** A builder for [ApologistOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.apologist.api.core.jsonMapper]. The default is usually sufficient and
        ...
        /**
         * Returns an immutable instance of [ApologistClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ApologistClientAsync =
            ApologistClientAsyncImpl(
                clientOptions
                    .httpClient(
