...
public class ApologistAgentClientBuilder {
     ...
     * Sets apiKey
     */
    public ApologistAgentClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public ApologistAgentClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public ApologistAgentClientBuilder url(String url) {
     ...
     */
    public ApologistAgentClientBuilder timeout(int timeout) {
     ...
     */
    public ApologistAgentClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public ApologistAgentClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public ApologistAgentClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public ApologistAgentClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public ApologistAgentClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public ApologistAgentClientBuilder logging(LogConfig logging) {
     ...
     */
    public ApologistAgentClientBuilder addHeader(String name, String value) {
        this.customHeaders.put(name, value);
        return this;
    }

    public ApologistAgentClientBuilder domain(String domain) {
        this.domain = domain;
        return this;
    }
    ...
    public ApologistAgentClient build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey");
        }
        validateConfiguration();
        return new ApologistAgentClient(buildClientOptions());
    }
}
