...
import com.apologist.api.core.Environment;
import com.apologist.api.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncApologistClientBuilder {
     ...
     * Sets apiKey
     */
    public AsyncApologistClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public AsyncApologistClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncApologistClientBuilder url(String url) {
     ...
     */
    public AsyncApologistClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncApologistClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncApologistClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncApologistClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncApologistClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncApologistClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncApologistClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncApologistClientBuilder addHeader(String name, String value) {
        this.customHeaders.put(name, value);
        return this;
    }

    public AsyncApologistClientBuilder domain(String domain) {
        this.domain = domain;
        return this;
    }
    ...
    public AsyncApologistClient build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey");
        }
        validateConfiguration();
        return new AsyncApologistClient(buildClientOptions());
    }
}
