...
public class ApologistClientBuilder {
     ...
     * Sets apiKey
     */
    public ApologistClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public ApologistClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public ApologistClientBuilder url(String url) {
     ...
     */
    public ApologistClientBuilder timeout(int timeout) {
     ...
     */
    public ApologistClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public ApologistClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public ApologistClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public ApologistClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public ApologistClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public ApologistClientBuilder logging(LogConfig logging) {
     ...
     */
    public ApologistClientBuilder addHeader(String name, String value) {
        this.customHeaders.put(name, value);
        return this;
    }

    public ApologistClientBuilder domain(String domain) {
        this.domain = domain;
        return this;
    }
    ...
    public ApologistClient build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey");
        }
        validateConfiguration();
        return new ApologistClient(buildClientOptions());
    }
}
