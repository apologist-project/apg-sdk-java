...
public class ApologistAiApiClientBuilder {
     ...
     * Sets apiKey
     */
    public ApologistAiApiClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public ApologistAiApiClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public ApologistAiApiClientBuilder url(String url) {
     ...
     */
    public ApologistAiApiClientBuilder timeout(int timeout) {
     ...
     */
    public ApologistAiApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public ApologistAiApiClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public ApologistAiApiClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public ApologistAiApiClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public ApologistAiApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public ApologistAiApiClientBuilder logging(LogConfig logging) {
     ...
     */
    public ApologistAiApiClientBuilder addHeader(String name, String value) {
        this.customHeaders.put(name, value);
        return this;
    }

    public ApologistAiApiClientBuilder domain(String domain) {
        this.domain = domain;
        return this;
    }
    ...
    public ApologistAiApiClient build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey");
        }
        validateConfiguration();
        return new ApologistAiApiClient(buildClientOptions());
    }
}
