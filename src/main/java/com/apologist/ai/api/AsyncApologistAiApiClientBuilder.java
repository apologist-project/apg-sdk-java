...
import com.apologist.ai.api.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncApologistAiApiClientBuilder {
     ...
     * Sets apiKey
     */
    public AsyncApologistAiApiClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public AsyncApologistAiApiClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncApologistAiApiClientBuilder url(String url) {
     ...
     */
    public AsyncApologistAiApiClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncApologistAiApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncApologistAiApiClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncApologistAiApiClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncApologistAiApiClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncApologistAiApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncApologistAiApiClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncApologistAiApiClientBuilder addHeader(String name, String value) {
        this.customHeaders.put(name, value);
        return this;
    }

    public AsyncApologistAiApiClientBuilder domain(String domain) {
        this.domain = domain;
        return this;
    }
    ...
    public AsyncApologistAiApiClient build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey");
        }
        validateConfiguration();
        return new AsyncApologistAiApiClient(buildClientOptions());
    }
}
