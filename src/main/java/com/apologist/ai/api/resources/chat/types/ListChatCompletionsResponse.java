 ...
 */
package com.apologist.ai.api.resources.chat.types;
...
@JsonDeserialize(builder = ListChatCompletionsResponse.Builder.class)
public final class ListChatCompletionsResponse {
    ...
    private ListChatCompletionsResponse(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListChatCompletionsResponse && equalTo((ListChatCompletionsResponse) other);
    }
    ...
    private boolean equalTo(ListChatCompletionsResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ListChatCompletionsResponse other) {
            data(other.getData());
        ...
        public ListChatCompletionsResponse build() {
            return new ListChatCompletionsResponse(data, total, page, perPage, additionalProperties);
        }
