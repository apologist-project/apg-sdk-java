...
public class UsersClient {
     ...
     */
    public ScrubUserResponse scrubUser(String userId) {
        return this.rawClient.scrubUser(userId).body();
    }

    /**
     * Replaces this user's message-adjacent text with a placeholder. Conversation rows, identifiers, flags, and analytics identity stay in place. Repeat calls finish leftover rows.
     */
    public ScrubUserResponse scrubUser(String userId, RequestOptions requestOptions) {
        return this.rawClient.scrubUser(userId, requestOptions).body();
    }

    /**
     * Replaces this user's message-adjacent text with a placeholder. Conversation rows, identifiers, flags, and analytics identity stay in place. Repeat calls finish leftover rows.
     */
    public ScrubUserResponse scrubUser(String userId, ScrubUserRequest request) {
        return this.rawClient.scrubUser(userId, request).body();
    }

    /**
     * Replaces this user's message-adjacent text with a placeholder. Conversation rows, identifiers, flags, and analytics identity stay in place. Repeat calls finish leftover rows.
     */
    public ScrubUserResponse scrubUser(String userId, ScrubUserRequest request, RequestOptions requestOptions) {
        return this.rawClient.scrubUser(userId, request, requestOptions).body();
    }
     ...
     */
    public AnonymizeUserResponse anonymizeUser(String userId) {
        return this.rawClient.anonymizeUser(userId).body();
    }

    /**
     * Redacts detected personal data in this user's message-adjacent text with regex, then an optional hosted redaction service when the Agent has that option on. Conversation rows, identifiers, flags, and analytics identity stay in place. Repeat calls finish leftover rows and skip text that is already redacted.
     */
    public AnonymizeUserResponse anonymizeUser(String userId, RequestOptions requestOptions) {
        return this.rawClient.anonymizeUser(userId, requestOptions).body();
    }

    /**
     * Redacts detected personal data in this user's message-adjacent text with regex, then an optional hosted redaction service when the Agent has that option on. Conversation rows, identifiers, flags, and analytics identity stay in place. Repeat calls finish leftover rows and skip text that is already redacted.
     */
    public AnonymizeUserResponse anonymizeUser(String userId, AnonymizeUserRequest request) {
        return this.rawClient.anonymizeUser(userId, request).body();
    }

    /**
     * Redacts detected personal data in this user's message-adjacent text with regex, then an optional hosted redaction service when the Agent has that option on. Conversation rows, identifiers, flags, and analytics identity stay in place. Repeat calls finish leftover rows and skip text that is already redacted.
     */
    public AnonymizeUserResponse anonymizeUser(
            String userId, AnonymizeUserRequest request, RequestOptions requestOptions) {
        return this.rawClient.anonymizeUser(userId, request, requestOptions).body();
    }
}
