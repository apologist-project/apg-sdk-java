 ...
 */
public class AgentClientApiException extends AgentClientException {
    /**
    ...
    public AgentClientApiException(String message, int statusCode, Object body) {
        super(message);
    ...
    public AgentClientApiException(String message, int statusCode, Object body, Response rawResponse) {
        super(message);
        this.statusCode = statusCode;
        this.body = body;
        this.headers = new HashMap<>();
