...
public class AsyncAgentClientBuilder {
     ...
     * Sets apiKey
     */
    public AsyncAgentClientBuilder apiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public AsyncAgentClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncAgentClientBuilder url(String url) {
     ...
     */
    public AsyncAgentClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncAgentClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncAgentClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
     ...
     */
    public AsyncAgentClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
     ...
     */
    public AsyncAgentClientBuilder retryJitterFactor(double retryJitterFactor) {
     ...
     */
    public AsyncAgentClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncAgentClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncAgentClientBuilder addHeader(String name, String value) {
        this.customHeaders.put(name, value);
        return this;
    }

    public AsyncAgentClientBuilder domain(String domain) {
        this.domain = domain;
        return this;
    }
    ...
    public AsyncAgentClient build() {
        if (apiKey == null) {
            throw new RuntimeException("Please provide apiKey");
        }
        validateConfiguration();
        return new AsyncAgentClient(buildClientOptions());
    }
}
